...
namespace BPCalculator
{
    ...
    public class BloodPressure
    {
        ...
        public BPCategory Category
        {
            get
            {
                //if ((Systolic >= 70.0 && Systolic <= 90.0) && (Diastolic >= 40 && Diastolic <= 60.0))
                if ((Systolic <= 90.0 || Diastolic <= 60.0))
                {
                    return BPCategory.Low;
                }
                else if ((Systolic >= 90 && Systolic <= 120.0) && (Diastolic >= 60 && Diastolic <= 80.0))
                {
                ...
                //else if ((Systolic <= 190.0) && (Diastolic <= 100.0))
                {
